...
# All signals: bundles, snipers, fresh wallets, dev, same-block buys,
# CEX deposits, wash trading, LP/bonding curve filter, copycat, price/mcap
...
# Programs that own LP/bonding curve token accounts - filter these out
LP_PROGRAMS = {
...
async def get_holders(client, mint):
    ...
    # Step 2: Build initial holder list
    holders = []
